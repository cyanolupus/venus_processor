function [D_INFO -1:0] decode_inst;
      ...
      case (d[W_OPC + IMMF - 1:IMMF])
        ...
        7'b001_0110: decode_inst = {1'b0,1'b0,1'b1,1'b0}; // SETL
        7'b001_0111: decode_inst = {1'b0,1'b0,1'b1,1'b0}; // SETH

        7'b001_1000: decode_inst = {1'b1,1'b1,1'b1,1'b0}; // LD
        7'b001_1001: decode_inst = {1'b1,1'b1,1'b0,1'b1}; // ST
